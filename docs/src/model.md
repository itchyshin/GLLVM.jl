...
surface for Gaussian, Poisson (log link), and complete-response binomial
logit/probit/cloglog point fits. With `fit_gaussian_gllvm(...; X_lv = X_lv)`,
`fit_poisson_gllvm(...; X_lv = X_lv)`, or `fit_binomial_gllvm(...; X_lv = X_lv)`,
