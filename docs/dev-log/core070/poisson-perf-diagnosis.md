...
> **Re-banked 2026-09-19 (lane speed78-20260919, on 69a69b0a0):** the 170.5 ms gradient wall at p=50 above predates the R2 mode-hoist repair this note prescribes (commit a04c9d26). Measured today on the current code with `bench/profile_laplace_allocs.jl` (twice): value 8.5 ms, gradient 95.6 ms, of which the ForwardDiff pass 91.6 ms with 383 MB of Dual allocations and the hoisted per-site mode solves 7.3 ms; 13 chunk passes (chunk 12, n_theta 149). TSV `bench/results/laplace_allocs_d807d96a7.tsv`. The 170.5 ms figure is kept for provenance, not as the baseline.
