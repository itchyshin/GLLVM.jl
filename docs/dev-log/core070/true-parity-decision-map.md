...
| **T3 tolerances** (signed 2026-09-05, M0-2) | Adopt draft rtol/abs in `second-order-parity-contract.md` §4; **conditioning recorded, not gated** | `second-order-parity-contract.md`; programme map P4 CLOSED |
| **T9 Promotion authority** (2026-09-05, M0-7) | **Draft PR + Rose scan = proposal**; **maintainer merge = sign-off** | `true-parity-programme-decision-map-2026-09-05.md` §Promotion authority |
| **Programme G0 locks** (2026-09-05) | Oracle 0.7.0 only for claim; tiered bridge; ~30–50 gate-tier; Totoro-first; θ-map research first | `true-parity-programme-decision-map-2026-09-05.md` §Destination |
