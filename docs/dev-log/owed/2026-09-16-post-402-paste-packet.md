...
Tip (2026-09-16): **`6ab636b7f`** (`docs: post-#399 paste packet @ #400`; engine #391 @ `c4dba35c4`).
...
## Adversarial scorecard (2026-09-16 @ `6ab636b7f` + DRAFTs #399 / #402)
...
| D3 Stage 1 | **PASTE-GATED** (DRAFT runbook) | DRAFT **[#402](https://github.com/itchyshin/GLLVM.jl/pull/402)** + [`plans/2026-09-16-d3-loading-profile-stage1-paste-gated-scaffold.md`](../plans/2026-09-16-d3-loading-profile-stage1-paste-gated-scaffold.md); paste `G0 Stage 1` |
| S4 public-formula probe | **PASTE-GATED** (DRAFT checklist) | DRAFT **#402** + [`plans/2026-09-16-s4-probe-julia-checklist-paste-gated.md`](../plans/2026-09-16-s4-probe-julia-checklist-paste-gated.md); paste `S4 probe yes` |
| Totoro #323 Track A | **PASTE-GATED** (DRAFT runbook) | DRAFT **#402** + [`plans/2026-09-16-totoro-323-track-a-runbook-paste-gated.md`](../plans/2026-09-16-totoro-323-track-a-runbook-paste-gated.md); paste `ack Totoro D-139 #323 Track A` |
...
**Ungated implementable engine slice:** **none**. Open ours DRAFTs (not ready): **#399**, **#402** (docs runbooks only).
