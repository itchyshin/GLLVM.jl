# True-parity paste packet (post-#415)

STATE: **IN PROGRESS**. Do **not** mark the programme or `/goal` complete.

ready-for-paste=yes.

This packet refreshes only the heads and gates after [#415](https://github.com/itchyshin/GLLVM.jl/pull/415) merged. It does not unlock, undraft, merge, or execute any paste-gated work.

## Current heads

- GLLVM.jl `origin/main`: **`85a4dcd6e`** ([#415](https://github.com/itchyshin/GLLVM.jl/pull/415), `docs: refresh post-414 paste packet`).
...
- Main Documenter at `85a4dcd6e`: success.
