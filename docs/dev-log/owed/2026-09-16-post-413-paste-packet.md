# True-parity paste packet (post-#416)

STATE: **IN PROGRESS**. Do **not** mark the programme or `/goal` complete.

ready-for-paste=yes.

This packet refreshes only the heads and gates after [#416](https://github.com/itchyshin/GLLVM.jl/pull/416) merged. It does not unlock, undraft, merge, or execute any paste-gated work.

## Current heads

- GLLVM.jl `origin/main`: **`487e2cb74`** ([#416](https://github.com/itchyshin/GLLVM.jl/pull/416), `docs: refresh post-415 paste packet`).
...
- Main Documenter at `487e2cb74`: success.
...
| [#409](https://github.com/itchyshin/GLLVM.jl/pull/409) | `d8ca0c177` | `S4 probe yes` | S4 public-formula probe against the recorder; no R engine edits |
| [#410](https://github.com/itchyshin/GLLVM.jl/pull/410) | `cd57d9b36` | `ack Totoro D-139 #323 Track A` | Optional #323 Track A run under D-139 |
