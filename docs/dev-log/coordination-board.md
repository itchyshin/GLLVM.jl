...
| **NB2/Beta+X Arc 2 (light RCall parity)** | **PR #177 open** (await CI → merge) | `parity/nb2-beta-x-arc2-20260802` (worktree `.worktrees/gllvmjl-nb2-beta-x-arc2-20260802`) | after-task `docs/dev-log/after-task/2026-08-02-nb2-beta-x-arc2-parity.md` | NB2+X/Beta+X light gllvmTMB logLik cells, 34/34 shared site-X cohort, full `Pkg.test` 5096/1/0. |
