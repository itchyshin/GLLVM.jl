...
| **Ordinal+X engine Arc 1** | **PR #180** (CI landing) | `fix/ordinal-x-pertrait-cov-20260803` | after-task `docs/dev-log/after-task/2026-08-03-ordinal-x-engine.md` · [#180](https://github.com/itchyshin/GLLVM.jl/pull/180) | `fit_ordinal_gllvm_pertrait_cov` + bridge/`@formula`; Julia identity. |
...
- `START HERE (Cursor):` merge #180 when green; push/PR Ordinal+X Arc 2 tip
  (`parity/ordinal-x-arc2-20260803`) when Shinichi asks (rebase onto post-#180
  `main` first). Dropbox checkout remains PROTECTED.
...
- 2026-08-03 — Ordinal+X **engine Arc 1** on PR
  [#180](https://github.com/itchyshin/GLLVM.jl/pull/180) (CI landing).
