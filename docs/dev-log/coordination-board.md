...
|---|---|---|---|---|
| **Destination B (frozen-0.7.0) G1/G2 closeout** | **MERGED** [#318](https://github.com/itchyshin/GLLVM.jl/pull/318) @ `6c46873a` | `main` @ `6c46873a` (squash merge of `codex/destination-b-b1-integration-20260910`) | G2 closeout `docs/dev-log/2026-09-13-destination-b-g2-closeout.md` · B1 decision `docs/dev-log/decisions/2026-09-13-destination-b-b1-close-as-limit.md` · after-task `docs/dev-log/after-task/2026-09-13-destination-b-close-as-limit.md` · numerical gates → `LOOP/arcs.md` (#321) | **Update (2026-09-14):** #318 **MERGED** — G1/G2 **documentation closeout** on `main` (B1 → close-as-limit; S3b consumer evidence fenced; S4 **HELD**). Pre-merge head: 8/8 Julia CI shards + Documenter green; **advisory** Frozen R 0.7.0 family smoke **still red** (known NB2+Student-t oracle debt; `continue-on-error`). Post-merge `main` CI run [34798728654](https://github.com/itchyshin/GLLVM.jl/actions/runs/34798728654) **in progress** at board tick. **≠ DestB programme complete ≠ S4 probe ≠ `Project.toml` bump ≠ numerical gates closed.** |
...
- 2026-09-14 — **Destination B G1/G2 docs closeout MERGED**
  [#318](https://github.com/itchyshin/GLLVM.jl/pull/318) @ `6c46873a`. Board
  row updated; advisory Frozen-R smoke remains red on merge head. Remaining
  DestB numerical work stays on `LOOP/arcs.md` (honest-0.7 programme, #321).
