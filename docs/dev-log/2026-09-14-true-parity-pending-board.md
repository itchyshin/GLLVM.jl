...
STATE: **IN PROGRESS**. **Mac Studio owns programme (STARTED 2026-09-15).** #323, matched-θ **(C)**, §2 Hessian **(A)** disposed (Ada defaults). Ledger gap inventory done. arcG Julia-only disposition ACCEPTED (#358 + gllvmTMB #1284). Still open: S4 probe, D3 Stage 1, `Project.toml` `0.3.0`, Delta dispersion paste. Merged SO tranche: #374/#376/#378; docs through #387-#390. **Rose WARN:** Tweedie estimated-power EOO is **pushed as two Ready+MERGEABLE PRs** (**#384** and **#391**) - both **HOLD** under #385/#388 push-auth (authorize one / close other; do not merge either without Shinichi paste). Open foreign: **#357** CONFLICTING (leave alone). Unrelated DRAFT skips: **#363/#314**. Paste-blocked; goal **not** complete.

Rehydrate: GLLVM.jl `origin/main` @ **`b68aa3da9`** (#390 ungated-queue verify on #389/#387); gllvmTMB `origin/main` @ `fba20d613`; frozen oracle `b4d5fee64def88bc768dda1f1f77c29b295edd86`; **`Project.toml` stays `0.3.0`**. Morning wake: [`handover/2026-09-16-morning-wake-briefing.md`](handover/2026-09-16-morning-wake-briefing.md).
...
Tweedie estimated-power (`tweedie_shared` / `tweedie_species`): **OPEN as #384 and #391** (both Ready+MERGEABLE) - **HOLD** (#385/#388 push-auth). Option A β-block compare; power coordinates not paired. Shinichi authorizes one / closes other before any merge.  
Still OUT / open: GP-1 ruling / Student-t free ν / Λ raw / Tweedie **estimated** (jointly-optimised, not plug-in) power **on main** (EOO PRs not merged).
...
- **Mac owns true-parity (STARTED 2026-09-15).** Tip `@ b68aa3da9` (#390). Next: Shinichi **authorize one of #384/#391 or close both** (#385/#388 HOLD); else paste gates / #357 when unblocked. Do **not** merge #384 or #391 without paste.
