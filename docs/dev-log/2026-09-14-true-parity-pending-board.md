...
- **Mac owns true-parity (STARTED 2026-09-15).** #374+#376+#378 MERGED (Tweedie shared-power SO cell landed, option A only). Next ungated: **FORWARD / TWIN_ALIAS hygiene** (#350/#355 tool rows) or Tweedie EOO push when authorized; coordinate **#357** when maintainer unblocks. Tweedie EOO stays on local `feat/tweedie-estimated-power-so-20260915` until push authorized.
