...
**Status:** **LOCAL DONE** — Poisson cell Δ≈4.20e-9 on
`parity/species-xb-light-20260804`. After-task:
`docs/dev-log/after-task/2026-08-04-species-xb-light-rcall.md`. Push/PR when
asked.
