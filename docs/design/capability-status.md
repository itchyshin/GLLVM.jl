...
- Light gllvmTMB logLik: named-route **63/63** + shared site-X
  Gaussian/Binomial/Poisson **18/18** + **Gamma+X** light cell (per-trait α,
  observed Laplace; Δ≈3e-8). Engine Arc 1 lands per-trait NB2/Beta/Gamma+X
  (Julia identity). **Light RCall NB2/Beta+X** remains #177 / fenced on other
  tip. Not full family parity; ADEMP and coverage certificates remain fenced.
