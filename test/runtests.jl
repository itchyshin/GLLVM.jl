...
include("test_aghq_public_binomial.jl")
    ...
    include("test_studentt_boundary_honesty.jl")
    include("test_studentt_boundary.jl")
    ...
    include("test_truncated_formula.jl")
    ...
    include("test_gaussian_fixed_residual.jl")
    include("test_gaussian_pervar_fallback.jl")
    include("test_formula_pervar.jl")
    ...
    include("test_gaussian_sources.jl")
    include("test_gaussian_sources_fixed_residual.jl")
    include("test_source_fit_optimizer_health.jl")
    include("test_cross_objective_known_answer.jl")
    include("test_cross_objective_helpers.jl")
    include("test_gaussian_source_design.jl")
    include("test_formula_sources.jl")
    include("test_formula_structured_terms.jl")
    include("test_gaussian_source_bindings.jl")
    include("test_bridge_gradient_payload.jl")
    include("test_bridge_sources.jl")
    ...
    include("test_se_machinery.jl")
    include("test_nobs_pn_convention.jl")
    ...
    include("test_ordinal_link_input.jl")
    include("test_core070_link_boundaries.jl")
