...
@testset "Destination B public PrecisionPhy routing" begin
    ...
    existing = GLLVM.fit_precision_multivariate(fixture.Y, fixture.phy;
        rank = 1, mode = :barelowrank, species_id = fixture.species_id,
        iterations = 0, g_tol = 1e-4)
    routed = fit_gllvm(fixture.Y; common...)
    @test routed isa GLLVM.PrecisionMultivariateFit
    ...
    direct_joint = GLLVM.fit_joint_phylo_grouped_gaussian(fixture.Y, fixture.phy;
    ...
    joint = fit_gllvm(fixture.Y; common..., grouping = fixture.terms,
        unit = fixture.unit)
    @test joint isa GLLVM.JointPhyloGroupedGaussianFit
    ...
    objective = GLLVM._joint_phylo_grouped_nll(joint.response, joint.phy,
    ...
    formula_fit = gllvm(@formula(y ~ 1 + x), fixture.Y, data;
        ...
        iterations = 0, g_tol = 1e-4)
    @test formula_fit isa GLLVM.JointPhyloGroupedGaussianFit
    ...
    @test formula_phylo isa GLLVM.PrecisionMultivariateFit
    ...
    @test_throws ArgumentError fit_gllvm(fixture.Y; common..., family = GLLVM.Poisson())
