# test_delta_lognormal_parity.jl — delta-lognormal GLLVModels logLik vs gllvmTMB
# (twin fid 12)
#
...
@testset "delta_lognormal GLLVModels parity: GLLVModels.jl vs gllvmTMB (twin fid 12, shared predictor)" begin
