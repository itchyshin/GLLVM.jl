...
| binomial/cloglog | fenced | — | — | DIAGNOSED: intrinsic Laplace saturation pathology (doubly-exponential tail ⇒ saturation ridge at moderate ‖Λ‖; link FD-verified correct; accurate at truth, +75 over-optimism at the runaway). A twin-parity + fit-health-diagnostic question, not a weight bug. Adjudication deferred until a saturation guard exists |
| tweedie | 150 (145 conv-both) | +0.05/+0.18/+0.12 by regime, %>0 = 98–100, means ≡ medians (no outlier tail) | tie (54% observed-closer; 0.56 vs 0.61) | **strongest flip case in the table** — uniform observed preference at negligible reported-loglik cost. Ran on Totoro (24 workers) after the oracle node-reduction (1001 nodes, validated bit-identical on the gp1 fixture) |
