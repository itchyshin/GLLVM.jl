...
| # | cell | status | gate? |
|---|------|--------|-------|
| 9 | `phylo_dep()` | **done** | `planned` — Arc 0 merged PR #324 @ `806b5476`; ledger row unchanged |
| 10 | `animal_dep()` | **in progress** | `planned` — Arc 0 `fit_animal_dep_gllvm` on branch `cursor/animal-dep-070-20260914` |
