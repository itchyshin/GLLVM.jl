# Core070 + AGHQ checkpoint

Read `docs/dev-log/plans/2026-08-30-core070-aghq-execution.md` first.

- Status: M1 IN PROGRESS. Programme NOT COMPLETE.
- Branch: codex/core070-aghq-20260830.
- Start: 7a4ac8de; R oracle b4d5fee64def88bc768dda1f1f77c29b295edd86.
...
## Milestone 1 checkpoint — 2026-08-30

- A1 census rerun through approved Unlazy gate: PASS; Luna low CLI review
  corrected by parent for the actual active article task `gllvmTMB_main2`.
- Census: Julia 103 registrations, 103 functional, 32 dirty, 71 clean;
  R 210 registrations, 42 functional, 122 missing, 46 broken, 10 dirty,
  32 clean. Missing/broken entries remain protected and unresolved.
- A2 Terra medium: preservation tool/self-tests/dry-run under review.
- A3 Terra high: frozen manifest and required parity runner in progress.
- A4 Terra high: phylogenetic diagnosis; bounded Totoro verification planned.
- Workers own disjoint files; see `.unlazy/core070-aghq/gates/leaf-A*.md`.
- Mission Control targeted correction verified served; local vault commit
  `f35161c`. R 0.7.1 fields preserved; exact status-file lease released.
...
## 2026-08-30 — Remote readback interrupted; local precision diagnosis retained
- Snapshot5be659b1 full family smoke:16-group terminal log read via tool217pass/3fail. New truncated NB2 R convergence failure; Student2 known. Tweedie started, but SSH/socket disappeared before final readback. Local launcher terminal; REMOTE STATE UNKNOWN. Do not restart on this observation failure.
- Exact remote /home/snakagaw/core070-aghq-20260830/family-recheck-01. Once authenticated ControlMaster restored, inspect live processes plus process/process-receipt.json, recover process/,sixteen-receipts/,tweedie-receipts/,matched/. Pending family-recheck-evidence.json rejects completion.
- Completed separate truncated NB2 health and scalar precision artifacts already local/pinned:6pass/3fail health plus1support, scalar3pass over60points. Mean-based recurrence resolves tested scalar precision against256-bit reference; native repair/derivative/limit/fitted validation unpaid. No source/fixture edits this slice.
- M1 PARTIAL/full manifest DRAFT; no restart/new auth or independent review workaround. Safe local contract/numerical design can continue; restore Totoro authentication for remote evidence recovery.
- Mission Control 55f734010a789234e0952566ad0c8472f7823738 locally committed and served HTTP200/readback verified; R fields unchanged. Board lease released. Local backup covers completed diagnostics and pending-recovery metadata only, not inaccessible remote final receipts.

## 2026-08-30 — Truncated NB2 stable scalar candidate
- Local numerical repair in truncated_nbinom2.jl,352 scalar assertions pass on exact copied source; failed package load,88 initial regressions and18 expanded failures preserved. Constant-work bounded series fixes large-r derivative cancellation; moments/observed curvature coherent. No tolerance, API or R change.
...
## 2026-08-30 — Binomial public-control qualification
-Curvature83.36s PASS: allsix Hessianspositive/stable, Newtondiagnosticgradients~1e-11. No singularmodel inference. PinnedRPORTrel/singtol slotsdefault1e-10each, relative-onlyoverride leaves singtolunchanged.
-Publicsing.tol1e-14 alongside rel.tol1e-14 qualifies5of6; probitvarying stillcode1falseconvgradient1.1164e-5. SeparatelypredeclaredpublicBFGScontinuation12.60s returnscode0/gradient1.1164e-5. Allsix public-control fits qualify, maxabsLLdelta6.83e-11; allhistoricalfailures retained. Finalverifier core070_verify_binomial_bfgs.py checkspriorchains/source/runtime/fixtures and negativecontrols.
...
## 2026-08-30 — Fixed Student-t df admission
-Totoro/Fir existing sockets verified; no fresh authentication or remote jobs. Fixed Inf df reproduced3fails (scalar/vector/generic marker), guarded with finite>0; valid native df<=1 preserved unlike R df>1. New27 input +51 unchanged scalar/AD checks PASS8.578s locally with real package, no fits. Seven gate negativesPASS; Unlazy1met1unmet. Tutorial empty-marker estimate wording corrected.
-Current source differs from prior binomial receipt source; six qualified models remain historical pending final candidate requalification. Original Student fitted-health failure not repaired. FullmanifestDRAFT/698nonexcluded sourcefacts still unmapped; M1PARTIAL. Next resume finite native/formula/bridge/source-case mapping, then original fitted health diagnoses. No newproductionchildren, no push/merge/cleanup.
- Mission Control Julia-only correction e8e0fdbdb618fc81829a37f5cdd6c19bf73b04e8 locally committed; servedHTTP200/readbackPASS, Rfields unchanged, leaseRELEASED.

## 2026-08-30 — Family entry contract
-Newfamily-route-contract.json/Markdown accounts69sourcefacts21required1alias33rejected14excluded.22 explicitJulia entry calls preserve pertraitGamma/Tweedie/Student/truncNB2, sharedonepartlognormal, sharedpredictorpertraitdelta, probitordinal; multinomialFEonly remainsgap. R69PASS, Julia21pass1failownCloglogLinktypo thencorrectCLogLogLink22PASS9.388s, sixcontractnegativesPASS. No response values/fits: admission afterdataaccess notverified. Fullsourcecasemap698nonexcludedstillunmapped; no promotion. Runtimefamily-routes-01, tools/core070_family_routes.py --verify. Unlazy1met1unmet. Next full model/estimand/interface bindings and originalStudent/truncNB2health; noBchildren/push/merge/cleanup.
- Mission Control Julia-only update df25df2c06bfca184f8711ceb71b98ebc00d87c7 servedHTTP200/readbackPASS; Rfieldsunchanged, leaseRELEASED.

## 2026-08-30 — Student same-parameter discrepancy isolated
...
## 2026-08-31 — public binomial integration, original pair still unmet
Read latest after-task/2026-08-31-core070-aghq-public-binomial.md and core070/aghq-public-binomial-evidence.json. Public binomial metadata/trials/masks/offsets/starts, frozen inference/profile/bootstrap and postfit now implemented. Legacy numeric body unchanged. Final241PASS; original public k5 pair149prereqPASS+5PASS/4FAIL, bothnonconverged LLdelta0.008938. Raw-success alternate start matches frozen R. Mean/trait-shape validation repaired in both binomial and Poisson; Noether final source review preceded last parent repair, no completion signoff. Strict docs executed/readback; alljobs terminal. GatesBU-PUBLICmet BU-PAIRunmet. NEXT remaining Stage1a controls/families and reviewed outer-adaptation diagnosis; do not replace original k5 or modify ridge/tolerance. M1PARTIAL/fullmanifestDRAFT/goalACTIVE. No B child before user checkpoint; no push/merge/release/cleanup/R-engine/foreign edits. Full suite and scientific campaigns require sized >30min approval.
...
## 2026-08-31 — internal Gaussian AGHQ verified, public integration next
