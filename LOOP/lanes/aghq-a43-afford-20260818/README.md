# Lane kit — aghq-a43-afford-20260818

Live afford LOOP for `cursor/lane-aghq-a43-afford-20260818`.

`LOOP/GOAL.md` on this tree is the overnight A4(3) file from
`origin/main` — **IMMUTABLE**. Do not edit it. Do not copy this
kit over that path.

| File | Role |
|---|---|
| `GOAL.md` | Afford mission (cheap `k^d` / `d≤5`) |
