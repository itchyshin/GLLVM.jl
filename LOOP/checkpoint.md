...
OPEN GATES: QS4; Stage 1; version bump forbidden; foreign #357 (conflict); Delta dispersion paste — **all wait on Shinichi paste**.
...
RESUME: Mac owns programme. Tip `df852f6b2` (#393). Cloud ungated exhausted after #391+#393. Remainder **Shinichi pastes only**. No Stage 1 / S4 / Totoro / Delta without paste; no Project.toml bump; no gllvmTMB engine surgery; do not edit #357. Goal **not** complete.
