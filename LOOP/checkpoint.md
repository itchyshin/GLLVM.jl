...
Rehydrate (2026-09-16): GLLVM.jl `origin/main` @ **`62091750d`** (#412 paste packet; #402 runbooks @ `08ca9e487`; #401 @ `c33745302`; #357 bridge @ `5ee6dc596`; #391 @ `c4dba35c4`); gllvmTMB origin/main @ `02b46cfc8`.

CLOUD STOP: Ungated cloud queue **exhausted** after **#391+#393 through #403**, **#401** @ `c33745302`, **#402** runbooks @ `08ca9e487`, and **#412** paste packet @ `62091750d`. No further ungated cloud engine slices. No mergeable leftover ours PRs. Next requires Shinichi pastes only.
...
DONE this tranche: (prior SO tranche through #378); **#385 through #397**; **#391** Tweedie estimated-power SO @ `c4dba35c4` -> **PARTIAL**; **#357** bridge logLik receipts @ `5ee6dc596`; **#401** node24 CI @ `c33745302`; **#402** paste-gated runbooks @ `08ca9e487`; **#412** canonical four-DRAFT paste packet @ `62091750d`.
...
RESUME: Mac owns programme. Tip `62091750d` (#412 paste packet merged). Cloud ungated exhausted. Remainder: Shinichi pastes only. No Stage 1 / S4 / Totoro / Delta without paste; no Project.toml bump; no gllvmTMB engine surgery. Goal **not** complete.
