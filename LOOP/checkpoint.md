...
Rehydrate (2026-09-15): GLLVM.jl origin/main @ deab192f (+ Multinomial Wald tip); gllvmTMB origin/main @ fba20d613.

NEXT (ranked):

1. Merge Multinomial FE Wald PR when Julia+Documenter green (Frozen R advisory OK).
...
IN FLIGHT: Multinomial FE Wald (`cursor/cloud-agent-1789479714671-jvn5g`); #357 CONFLICTING (foreign). Skipped #363/#314.

DONE this tranche: ledger gap inventory; Delta SO wiring (#347); §2 Hessian (A); twin-bridge inventory (#353); #359 cloglog @test fix; #360 board; #358/#1284 arcG; #362 OrdinalPerTrait Wald; #356 TweedieGrouped Wald; #361 Lognormal+TruncPois+TruncNB2 Wald; #355 parity_ledger aliases; #364/#365 board tips; **Multinomial FE Wald** (this tip).
...
HOLD OUTS (SO): GP-1 / Student-t free ν / Delta species dispersion / BB shared-φ pairing / Λ raw still OUT; Ordinal+Lognormal+Trunc*+Multinomial FE PARTIAL (native Wald; bridge CI waits #357).

RESUME: Prefer next ungated Wald/_CIFit if any remain; else paste-blocked. No Stage 1 / S4 / Totoro without paste; no Project.toml bump; no gllvmTMB engine surgery; do not edit #357.
