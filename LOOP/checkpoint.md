...
Rehydrate (2026-09-15): GLLVM.jl origin/main @ c1842dd69 (#366 MultinomialFit Wald MERGED); gllvmTMB origin/main @ fba20d613.

NEXT (ranked):

1. #357 bridge receipts: foreign; CONFLICTING (check-log.md only). Do not edit.
...
IN FLIGHT: #357 CONFLICTING (foreign). Skipped #363/#314.

DONE this tranche: ledger gap inventory; Delta SO wiring (#347); §2 Hessian (A); twin-bridge inventory (#353); #359 cloglog @test fix; #360 board; #358/#1284 arcG; #362 OrdinalPerTrait Wald; #356 TweedieGrouped Wald; #361 Lognormal+TruncPois+TruncNB2 Wald; #355 parity_ledger aliases; #364/#365 board tips; **#366 MultinomialFit Wald** (`c1842dd69`); native Wald PARTIAL.
...
RESUME: Paste-blocked STATE. No ungated Wald/_CIFit remaining on this menu. No Stage 1 / S4 / Totoro without paste; no Project.toml bump; no gllvmTMB engine surgery; do not edit #357.
