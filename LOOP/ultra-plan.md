<!-- FROZEN at G0 approval for /goal run 2026-08-01. Do not re-plan. -->
<!-- Locked defaults: Q1 Gaussian→Bin→Pois then #132/#148/#133; Q2 align Julia→R; Q3 fence #129/#128; NotebookLM=no. -->
<!-- Arc ids in LOOP/arcs.md follow /goal binding (A1=inventory, A2=Gaussian headline). -->

# Ultra-plan — GLLVM.jl catch-up: light gllvmTMB logLik oracle

**Date:** 2026-08-01  
**Orchestrator:** Ada (Cursor session)  
**Mode:** G0 APPROVED · Phase 3 via /goal (frozen copy)  
...
**G0 APPROVED** (Shinichi via /goal launch; Ada defaults on Q1–Q3). Phase 3 executing under LOOP/. Reply with approvals / “use your judgment” on Q1–Q3 (+ optional NotebookLM yes/no), then paste the `/goal` prompt into a **fresh Cursor chat**.
