...
class Collection(unittest.TestCase):
    def setUp(self):
        ...
        self.ids = [row['id'] for row in draft['obligation'] if row['id'] not in draft.get('public_r_bridge_case_ids',[])+draft.get('covariance_case_ids',[])+draft.get('covariance_formula_case_ids',[])]
