...
def self_test(manifest_path: Path) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        source = {
            ...
            "julia_source_tree_sha256": tree_digest(ROOT / "src"), "julia_package_path": "/tmp/GLLVModels/src/GLLVModels.jl",
            "julia_package_root": "/tmp/GLLVModels", "julia_project_path": "/tmp/GLLVModels/test/parity/Project.toml",
