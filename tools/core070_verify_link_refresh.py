...
ROOT=links.ROOT
def verify():
    with patch.object(nb2,'STATE',ROOT/'.unlazy/core070-aghq/nb2-formula-required-03'):nb2.verify()
    with patch.object(shape,'STATE',ROOT/'.unlazy/core070-aghq/family-boundaries-03'):shape.verify()
    state=ROOT/'.unlazy/core070-aghq/ordinal-link-parity-01'
