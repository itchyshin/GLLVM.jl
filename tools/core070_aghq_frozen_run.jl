...
for H in [[2.0 .3;.3 1.0],[-.25 0.;0. 2.],[0. 0.;0. 2.],[1e-12 0.;0. 2.],[2. .4;.2 1.]]
    a=GLLVModels.aghq_adaptation([.1,-.2],H)
...
open(io->TOML.print(io,Dict("factors"=>records,"julia_version"=>string(VERSION),"package_root"=>pkgdir(GLLVModels))),ENV["CORE070_AGHQ_FROZEN_OUTPUT"],"w")
