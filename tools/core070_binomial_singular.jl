# Public singular-tolerance qualification; preserve complete fits and previous failures.
...
policy_path = joinpath(@__DIR__, "..", "docs/dev-log/core070/binomial-singular-policy.toml")
...
println("BINOMIAL_SINGULAR_QUALIFICATION_PASS ",id)
