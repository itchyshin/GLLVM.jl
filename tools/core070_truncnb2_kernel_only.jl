...
const GLLVModels=Core070Kernel
const LogLink=Core070Kernel.LogLink
fixture="test/test_truncnb2_precision.jl"
source=read(fixture,String)
startswith(source,"using GLLVModels, Test, SpecialFunctions, ForwardDiff\n") || error("unexpected test imports")
source=replace(source,"using GLLVModels, Test, SpecialFunctions, ForwardDiff\n"=>"";count=1)
