...
BetaFit(β, Λ, φ, link, loglik, converged, iterations, alpha_lv, theta_packed) =
    BetaFit(β, Λ, φ, link, loglik, converged, iterations, alpha_lv, theta_packed, _default_hessian(Beta(1.0, 1.0), link))
