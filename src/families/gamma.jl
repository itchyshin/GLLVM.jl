...
GammaFit(β, Λ, α, link, loglik, converged, iterations, alpha_lv, theta_packed) =
    GammaFit(β, Λ, α, link, loglik, converged, iterations, alpha_lv, theta_packed, _default_hessian(Gamma(1.0, 1.0), link))
